...
#from tools import CIFAR10DataColl
import os
...
parser.add_argument("--attribute", type=str, required=False, choices=["isMaleisFemale", "isRace"], default="isMaleisFemale")
